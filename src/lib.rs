...
use crate::cli::{file_content, flag, paper, string, timeout, SUBCOMMAND_MULTIPLE, SUBCOMMAND_SINGLE, SUBCOMMAND_URL};
...
use clap::{crate_description, crate_name, crate_version, ArgMatches};
use std::fs;
use std::path::Path;
